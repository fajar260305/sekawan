    ...
    <div class="container-fluid m-0">
        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
            ...
            <li class="nav-item dropdown">
                ...
                <li><a class="dropdown-item" href="/dashboard/atasan">List pesanan</a></li>
        ...
        <div class="col-lg-3 col-6 col-sm-6 d-flex justify-content-center align-items-center pt-2 pb-2">
            <div class="card" style="width: 18rem;">
                ...
                <div class="card-body">
                    ...
                    <a href="#" class="btn btn-dark">Pesan <i class="bi bi-arrow-right-short"></i></a>
                </div>
            </div>
        </div>
        <div class="col-lg-3 col-6 col-sm-6 d-flex justify-content-center align-items-center pt-2 pb-2">
...
<?php echo $__env->make('Homepage.layout.Header', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\sekawan\Pemesanan_kendaraan\resources\views/Homepage/pesanan/Index.blade.php ENDPATH**/ ?>