...
<div class="container-fluid">
  ...
  <form class="row g-3" enctype="multipart/form-data" action="/dashboard/kendaraan/<?php echo e($kendaraans->id); ?>" method="POST">
...
unset($__errorArgs, $__bag); ?>
        ...
        <div class="col-md-6">
          ...
          <input type="hidden" class="form-control <?php $__errorArgs = ['image'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>" value="<?php echo e($kendaraans->gambar); ?>" name="oldimage" id="inputPassword4">
...
unset($__errorArgs, $__bag); ?>" value="<?php echo e($kendaraans->gambar); ?>" name="image" id="inputPassword4">
...
unset($__errorArgs, $__bag); ?>" value="<?php echo e($kendaraans->konsumsi_bbm); ?>" name="konsumsi_bbm" id="inputAddress" placeholder="Satuan liter">
...
unset($__errorArgs, $__bag); ?>" value="<?php echo e($kendaraans->jadwal_service); ?>" name="jadwal_service" id="inputAddress2" placeholder="Apartment, studio, or floor">
...
unset($__errorArgs, $__bag); ?>" value="<?php echo e($kendaraans->jumlah); ?>" name="jumlah" id="inputCity">
...
<?php echo $__env->make('dashboard.layout.footer', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\sekawan\Pemesanan_kendaraan\resources\views//dashboard/kendaraan/ubah.blade.php ENDPATH**/ ?>