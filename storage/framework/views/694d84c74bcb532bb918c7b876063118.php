        ...
        <table class="table table-white table-striped table-responsive">
          ...
          <tbody>
            ...
            <tr>
              ...
              <td class="col pt-3"><?php echo e($pesanan->izin); ?></td>
              <td class="col">
                <a href="/dashboard/pesanan/<?php echo e($pesanan->id); ?>/edit" class="btn btn-outline-primary">
                  <i class="bi bi-pencil-square"></i>
                </a>
                <form action="/dashboard/pesanan/<?php echo e($pesanan->id); ?>" method="post" class="d-inline">
...
<?php /**PATH D:\sekawan\Pemesanan_kendaraan\resources\views//dashboard/pesanan/index.blade.php ENDPATH**/ ?>